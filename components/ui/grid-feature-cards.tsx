...
export function FeatureCard({ feature, className, ...props }: FeatureCardProps) {
    // The squares are random, so generate them on the client after mount.
    // Computing them during render would make the server and client disagree
    // and throw a hydration mismatch on every card.
